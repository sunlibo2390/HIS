...
class MLoraModel(PeftModel, nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.base_model.active_adapter = self.active_adapters
    ...
    def _setup_prompt_encoder(self, adapter_name: str):
        # Override prompt-encoder setup from base class; MLora does not use prompt encoders.
        return
    ...
    def _find_and_replace(self, adapter_names, insert_mode):
        """Insert MOE adapters according to configured layout strategy."""
    ...
    class MLinear8bitLt(bnb.nn.Linear8bitLt, MLoraLayer):
        ...
        def __init__(
            ...
            **kwargs,
            ...
            signature = _inspect.signature(bnb.nn.Linear8bitLt.__init__)
